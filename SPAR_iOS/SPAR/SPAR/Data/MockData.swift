...
struct MockData {
    ...
    [
        {
            ...
            "cpuUsage": 12.5,
            "memoryMB": 200.0,
            "registeredAt": "2025-04-13T15:29:00.236114"
        },
        {
            "userId": 1,
            "id": 102,
    ...
    static let sampleBatteryData = """
        {
            ...
            "registeredAt": "2025-04-13T15:29:10.549936",
            "charging": false
        }
    """.data(using: .utf8)!
    ...
    static let sampleMemoryUsageData = """
        {
            ...
            "usedMemory": 8.5,
            "availableMemory": 7.5,
            "registeredAt": "2025-04-13T15:28:49.261218"
        }
    """.data(using: .utf8)!
    static let sampleDiskUsageData = """
      {
              ...
              "registeredAt": "2025-04-22T15:57:10.390972"
      }
    """.data(using: .utf8)!
    static let sampleCPUUsageData = """
    {
        ...
        "registeredAt": "2025-04-29T18:02:05.970927"
    }
    """.data(using: .utf8)!
    static let sampleDiskIOUsageData = """
       {"id": 5,
          ...
          "userId": 1,
          "deviceId": "331330ac-5f82-43b0-9d39-84e1f7e7e358",
          "registeredAt": "2025-04-22T15:57:10.377292"
    }
    """.data(using: .utf8)!
