...
public class MetricsBatchService {
    ...
    public String addMetrics(MetricsBatchDTO batch) {
        ...
        User user = userRepo.findById(batch.getUserId())
                .orElseThrow(() -> new IllegalArgumentException(AppConstants.UNKNOWN_USER_ID + AppConstants.EQUALS_TO+batch.getUserId()));
        ...
        DeviceSpecification device = deviceRepo.findByUserAndDeviceId(user, batch.getDeviceId())
                .orElseThrow(() -> new IllegalArgumentException(
                        AppConstants.DEVICE + batch.getDeviceId() + AppConstants.NOT_REGISTERED_FOR_USER + batch.getUserId()));
